...
export default function Footer() {
    return (
        <footer className="bg-white shadow-sm dark:bg-gray-900 mt-[10px]">
            <div className="w-full max-w-screen-xl mx-auto p-4 sm:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <Link to="/" className="flex items-center justify-between mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
