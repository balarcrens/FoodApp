...
export default function About() {
    ...
    return (
        <>
                ...
                <div className="py-16 px-6">
                    <div className="mx-auto max-w-7xl text-center">
                        ...
                        <div className="flex flex-wrap justify-center gap-8">
                            <div className={`max-w-xs p-6 rounded-lg shadow-md ${localStorage.getItem('theme') === 'dark' ? 'border' : ''}`} data-aos="fade-right" data-aos-duration="1000">
                            ...
                            <div className={`max-w-xs p-6 rounded-lg shadow-md ${localStorage.getItem('theme') === 'dark' ? 'border' : ''}`} data-aos="fade-left" data-aos-duration="1000">
                                <h3 className="text-xl font-semibold text-indigo-600 mb-2">
            ...
            <div aria-hidden="true" className="absolute inset-x-0 top-[calc(100%-50rem)] -z-10 transform-gpu overflow-hidden blur-2xl sm:top-[calc(100%-50rem)]" >
