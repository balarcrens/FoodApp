...
export default function Profile() {
    ...
    return (
        <>
            ...
            <div className="flex flex-col max-w-3xl mx-auto h-100 my-32 p-6 shadow-xl rounded-xl justify-center ">
            <h1 className="text-2xl font-bold mt-2">Profile :</h1>
                <div className="flex justify-center space-x-6 flex-wrap my-auto">
                    <img className="w-24 h-24 rounded-full border-2 border-indigo-500" src={user.avatar || "/images/user.png"} alt={user.user.name} />
                    <div>
