                            ...
                            {filteredFoods.length === 0 ? (
                                ...
                                <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                                    {filteredFoods.map((food, index) => (
                                        <div key={food._id} onClick={() => handleFoodClick(food)} className="group cursor-pointer" data-aos="fade-up" data-aos-duration={`${1500 + index * 100}`} data-aos-delay={`${index * 100}`} data-aos-easing="ease" data-aos-anchor-placement="top-bottom">
